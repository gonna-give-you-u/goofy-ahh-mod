...
public class DropAnvilsProMaxProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(Blocks.ANVIL)) : false) {
			...
			if (anvils >= 25) {
				...
				world.setBlock(BlockPos.containing(x - 1, y + 15, z), Blocks.ANVIL.defaultBlockState(), 3);
				world.setBlock(BlockPos.containing(x - 1, y + 15, z - 1), Blocks.ANVIL.defaultBlockState(), 3);
				world.setBlock(BlockPos.containing(x - 2, y + 15, z - 2), Blocks.ANVIL.defaultBlockState(), 3);
				world.setBlock(BlockPos.containing(x - 2, y + 15, z - 1), Blocks.ANVIL.defaultBlockState(), 3);
				world.setBlock(BlockPos.containing(x - 2, y + 15, z), Blocks.ANVIL.defaultBlockState(), 3);
				world.setBlock(BlockPos.containing(x - 2, y + 15, z + 1), Blocks.ANVIL.defaultBlockState(), 3);
				world.setBlock(BlockPos.containing(x - 2, y + 15, z + 2), Blocks.ANVIL.defaultBlockState(), 3);
				world.setBlock(BlockPos.containing(x - 1, y + 15, z + 2), Blocks.ANVIL.defaultBlockState(), 3);
				world.setBlock(BlockPos.containing(x - 1, y + 15, z - 2), Blocks.ANVIL.defaultBlockState(), 3);
				world.setBlock(BlockPos.containing(x, y + 15, z - 2), Blocks.ANVIL.defaultBlockState(), 3);
				world.setBlock(BlockPos.containing(x, y + 15, z + 2), Blocks.ANVIL.defaultBlockState(), 3);
				world.setBlock(BlockPos.containing(x + 1, y + 15, z + 2), Blocks.ANVIL.defaultBlockState(), 3);
				world.setBlock(BlockPos.containing(x + 1, y + 15, z - 2), Blocks.ANVIL.defaultBlockState(), 3);
				world.setBlock(BlockPos.containing(x + 2, y + 15, z - 2), Blocks.ANVIL.defaultBlockState(), 3);
				...
				if (entity instanceof Player _player) {
					...
					_player.getInventory().clearOrCountMatchingItems(p -> _stktoremove.getItem() == p.getItem(), 25, _player.inventoryMenu.getCraftSlots());
				}
			}
		}
	}
