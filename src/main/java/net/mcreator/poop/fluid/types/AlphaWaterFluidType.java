...
public class AlphaWaterFluidType extends FluidType {
	...
	public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
		consumer.accept(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = new ResourceLocation("poop:block/water_still");
			private static final ResourceLocation FLOWING_TEXTURE = new ResourceLocation("poop:block/water_flow");
			private static final ResourceLocation RENDER_OVERLAY_TEXTURE = new ResourceLocation("poop:textures/water_overlay.png");
