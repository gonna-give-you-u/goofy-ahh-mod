...
import net.mcreator.poop.init.PoopModPaintings;
...
public class PoopMod {
	public static final Logger LOGGER = LogManager.getLogger(PoopMod.class);
	...
	public PoopMod() {
		...
		PoopModSounds.REGISTRY.register(bus);
		PoopModBlocks.REGISTRY.register(bus);

		PoopModItems.REGISTRY.register(bus);
		...
		PoopModPaintings.REGISTRY.register(bus);
