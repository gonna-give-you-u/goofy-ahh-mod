...
public class PooperEntity extends Monster {
	public PooperEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PoopModEntities.POOPER.get(), world);
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(PoopModItems.POOP_FRAGMENT.get()));
	}

	@Override
	public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("poop:reverb_fard"));
	}
	...
	public SoundEvent getDeathSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("poop:fard"));
	}
