...
public class GoofyAhhModServerConfigConfiguration {
	...
	public static final ForgeConfigSpec.ConfigValue<Boolean> NUKE_DROPS_ITEMS;
	public static final ForgeConfigSpec.ConfigValue<Boolean> YOURE_GOING_TO_BRAZIL;
	public static final ForgeConfigSpec.ConfigValue<Boolean> ENABLE_CRASHER;
	public static final ForgeConfigSpec.ConfigValue<Boolean> ENTITY_DELETERS_PLAYERS;
	public static final ForgeConfigSpec.ConfigValue<Double> OBAMA_SPHERE_RANGE;
	static {
		...
		NUKE_DROPS_ITEMS = BUILDER.comment("Whether nuke explosions drop blocks as items").define("Nuke drops items", true);
		YOURE_GOING_TO_BRAZIL = BUILDER.comment("Whether the Brazil Entity can spawn naturally").define("Brazil Entity Spawn", true);
		ENABLE_CRASHER = BUILDER.comment("Whether the Crasher item will actually close the game").define("Crasher Works", false);
		BUILDER.push("OP stuff");
		...
		OBAMA_SPHERE_RANGE = BUILDER.comment("Radius in which the Obama Sphere instakills stuff").define("Obama Sphere range", (double) 10);
		BUILDER.pop();
		BUILDER.pop();
